        ...
        fab.setOnClickListener({ view ->
            ...
            if (alertDialog == null || !(alertDialog!!.isShowing)) {
                if (enabled) {
                    ...
                    val prefsAllowedPackages: MutableSet<String> = MainApplication.sharedPrefs.getStringSet(MainApplication.PREFS_KEY_ALLOWED_PACKAGES, mutableSetOf()) as MutableSet<String>
